...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN P1_26          // Set a custom pin for the controller fan (P1_26 == Y_MAX_PIN)
 ...
 */
#define E0_AUTO_FAN_PIN P2_04 // (P2_04 == FAN1_PIN)
...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_PIN P1_24                // Override the default pin if needed (P1_24 == Z_MAX_PIN)
